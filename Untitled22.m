...
%ra=table2array(ra);
%dec=table2array(dec);
%pmra=table2array(pmra);
%pmdec=table2array(pmdec);
%rcl=table2array(rcl);
b=predict_values([ra,dec],b);
v=predict_values([ra,dec],v);
pmra=predict_values([ra,dec],pmra);
pmdec=predict_values([ra,dec],pmdec);
b_v=b-v;
